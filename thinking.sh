...
# ==============================================================================
#      AI Core Modular - Launcher v6.0 ("Thinking" 模型版)
# ==============================================================================
# v6.0 更新:
# - 【模型更换】: 已按照您的最新要求，将模型路径和参数更新为
#   "Qwen3-VL-30B-A3B-Thinking-1M"。
#
# v5.0 核心功能:
...
# ##############################################################################
# ### --- 本地视觉模型服务器配置 (已更新为 "Thinking" 模型) --- ###
# ##############################################################################
MODEL_SERVER_DIR="$HOME/llama.cpp/build-vulkan-new"
# 新的 "Thinking" 模型 GGUF 文件路径
MODEL_PATH="/mnt/data/models/Qwen3-VL-30B-A3B-Thinking-1M/Qwen3-VL-30B-A3B-Thinking-1M-UD-TQ1_0.gguf"
# 新的 "Thinking" 模型 mmproj 文件路径
MMPROJ_PATH="/mnt/data/models/Qwen3-VL-30B-A3B-Thinking-1M/Qwen3-VL-30B-A3B-Thinking-1M-UD-mmproj-BF16.gguf"
...
clear
echo "========================================================"
echo "    AI Core Modular - Launcher v6.0 (\"Thinking\" 模型版)"
echo "========================================================"
echo ""
