...
# ==============================================================================
#      AI Core Modular - Launcher v8.0 ("Coder" 模型版)
# ==============================================================================
# v8.0 更新:
# - 【模型更换】: 已按照您的最新要求，将模型路径和参数更新为
#   "Qwen3-30B-A3B-Instruct-2507-UD-TQ1_0"。这是一个纯代码模型，无视觉模块。
#
# v7.0 核心功能:
...
clear
echo "========================================================"
echo "    AI Core Modular - Launcher v8.0 (\"Coder\" 模型版)"
echo "========================================================"
echo ""
