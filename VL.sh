...
# ==============================================================================
#      AI Core Modular - Launcher v5.0 (智能等待版)
# ==============================================================================
# v5.0 更新:
# - 【核心优化】: 采纳您的建议！用智能轮询取代固定时间的 sleep。
#   脚本会每隔3秒检查一次服务器状态，一旦启动成功便立即继续，
#   不再愚蠢地等待固定时长，极大提升了启动效率。
# ==============================================================================
...
MODEL_PATH="/mnt/data/models/Qwen3-VL-30B-A3B-Instruct-GGUF/Qwen3-VL-30B-A3B-Instruct-UD-TQ1_0.gguf"
MMPROJ_PATH="/mnt/data/models/Qwen3-VL-30B-A3B-Instruct-GGUF/mmproj-BF16.gguf"
...
clear
echo "========================================================"
echo "    AI Core Modular - Launcher v5.0 (智能等待版)"
echo "========================================================"
echo ""
